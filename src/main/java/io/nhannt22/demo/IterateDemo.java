...
public class IterateDemo {
    public static void main(String[] args) throws Exception {
        ...
        // Iterate method initiates an iterative part of the program
        // By default, data stream with iteration will never terminate => if no data received in the set time, the stream will terminate
        ...
        // Send back to iterative stream using 'closeWith' method
        iteration.closeWith(notEqualtoten); // pass the data stream name to be feedback
